                       ...
                       <div class="row">
                        ...
                        <div class="col-md-6">
                          <div class="mb-3">
                            ...
                            <select class="form-select" name="type" onchange="check_office(this.value)" required>
                        ...
                        <div class="col-md-6">
                          <div class="mb-3">
                            <label>Email</label>
                            <input class="form-control" name="email" type="email" placeholder="Value *" required>
                          </div>
                        </div>
                        ...
                        <div class="col-md-6">
                          <div class="mb-3">
                            <label>Phone</label>
                            <input class="form-control" name="phone" id="phone_otp" onkeyup="checkphn(this.value);" oninput="numberOnly(this.id);" maxlength="10" type="number" placeholder="Value *" required>
                          </div>
                        </div>
                        ...
                        <div class="col-md-6">
                          <div class="mb-3">
                            ...
                            <input class="form-control" name="alternate_phone" id="phone1_otp" onkeyup="checkphn(this.value);" oninput="numberOnly(this.id);" maxlength="10" type="number" placeholder="Value *">
                          </div>
                        </div>
                        ...
                        <input type="date" class="form-control" name="birth_date" placeholder="Select Date" name="pincode">
                        </div>
                      </div>
