...
<html lang="en"> 
  <head>
     <?php if(!Session::get('rexkod_apex_user_id')){ 
     ?>
     <script>window.location = "/";</script>
     <?php } 
     
    
     $notifications = Notification::where('to_id',Session::get('rexkod_apex_user_id'))
      ->where('status','0')
      ->get();
    ...
    <title>Pragati - The Art of Living</title>
    <!-- Google font-->
      ...
      <div class="page-header">
        <div class="header-wrapper row m-0"> 
          ...
          <div class="nav-right col-10 col-sm-6 pull-right right-header p-0">
            ...
            <?php if(Session::get('rexkod_apex_user_type') == "apex" || Session::get('rexkod_apex_user_type') == "ddc" || Session::get('rexkod_apex_user_type') == "tdc" || Session::get('rexkod_apex_user_type') == "vdc" || Session::get('rexkod_apex_user_type') == "accountant" || Session::get('rexkod_apex_user_type') == "administrator" || Session::get('rexkod_apex_user_type') == "hq"){ 
            ...
            ?> 
              ...
              <li class="onhover-dropdown">
                <div class="notification-box">
                  ...
                  </svg><span class="badge rounded-pill badge-warning"><?php echo count($notifications); ?> </span>
                </div>
                  ...
                  ?>
                    <li>
                      ...
                      <a href="/notifications">
                        <div class="notification-img bg-light-primary"><i class="fa fa-bell" style="color:orange"></i></div>
                        ...
                        <div class="notification-right">  <a href="/update_notification/<?php echo $notification->id; ?>/1"><i style="width:15px" data-feather="x"></i></a></div>
                      </div>
                      </form>

                    </li>
                  <?php if($noti_count == 3){ break;} }?>   
                   <li></li>
                     <li class="p-0"><a class="btn btn-primary" href="/notifications">Check all</a></li> 
                  </ul>
                </div>
                <?php } ?>
              </li>
