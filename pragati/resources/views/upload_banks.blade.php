              ...
              <div class="row">
                ...
                <div class="col-12 col-sm-6">
                  <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Upload Banks</li>
                  </ol>
                  <br>
                  <ol class="breadcrumb">

                    <li class="breadcrumb-item"><a href="/assets/pragati_upload_banks.csv" download="pragati_upload_banks.csv">Download File</a></li>
              ...
              <div class="col-sm-12 box-col-12 col-xl-12 col-xxl-6">
                ...
                <div class="card-body">
                                <div class="basic-form custom_file_input">
                                    <form action="/bulk_upload_banks" enctype="multipart/form-data" method="POST">
                                      @csrf
