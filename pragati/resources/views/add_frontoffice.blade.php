    ...
    .strong-password {
        ...
        <div class="page-body">
            ...
            <div class="page-title">
              <div class="row">
                <div class="col-12 col-sm-6">
                  <h3>Add Apex Member</h3>
                </div>
                <div class="col-12 col-sm-6">
                  <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="index">                                       <i data-feather="home"></i></a></li>
                    <li class="breadcrumb-item">Home</li>
                    <li class="breadcrumb-item active"> Add Apex Member</li>
                  </ol>
                </div>
              </div>
            </div>
          ...
          <div class="container-fluid">
            ...
            <form action="create_frontoffice" method="POST" enctype="multipart/form-data">
              @csrf
              <div class="row">
                    ...
                    <h4>Personal Information</h4><hr>
                       ...
                       <div class="row">
                        ...
                        <div class="col-md-6">
                          <div class="mb-3">
                            <label>Phone</label>
                            <input class="form-control" name="phone" id="phone_otp" onkeyup="checkphn(this.value);" oninput="numberOnly(this.id);" maxlength="10" type="number" placeholder="Value *">
                          </div>
                        </div>
