                ...
                <div class="card">
                  <div class="card-body">
                    <div class="form theme-form projectcreate">
                      ...
                      <div class="row">
                        ...
                        <div class="col">
                          <div class="mb-3">
                            ...
                            <input class="form-control" type="text" name="project_address" placeholder="Enter Address">
                          </div>
                        </div>
                        </div>
                      </div>
                      ...
                      <div class="row">
                        ...
                        <div class="col">
                          <div class="mb-3">
                            ...
                            <input class="form-control" type="date" name="project_start_date" placeholder="">
                          </div>
                        </div>
                        </div>
                        <div class="col-md-6">
                        <div class="col">
                          <div class="mb-3">
                            ...
                            <input class="form-control" type="date" name="project_end_date" placeholder="">
                          </div>
                        </div>
                        </div>
                      </div>
                      ...
                      <div class="row">
                        <div class="col">
                          <div class="text-end"><button class="btn btn-secondary me-3" type="submit">Add</button></div>
                        </div>
                      </div>
                    </div>
                  </div>
