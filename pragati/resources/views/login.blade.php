...
<head>
  ...
  <title>Pragati - Apex Admin </title>
  <!-- Google font-->
...
?>
 ...
 <div class="row">
  ...
  <form method="post" class="login-new" action="/user_login" autocomplete="off">
             @csrf
            <center><h3 style="margin:15px 0px;color:#333">Pragati</h3></center><hr>

              <div class="form-group">
                <div class="input-group">
                  <input style="border-radius:25%;border-radius: 25px;padding: 15px;" onkeyup="checkphn(this.value);" type="text" placeholder="Enter Phone Number" class="form-control" id="phone" name="phone" required maxlength="10">
            ...
            <br>
              <center><h4 style="color:#333">Not yet registered,<a style="color:#333;text-decoration:underline" class="ms-2" href="/register">Register.</a></h4></center>
            </form>
  </div>
  <!-- frameworks end-->
 </div>
