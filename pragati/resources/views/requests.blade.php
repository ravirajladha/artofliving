                    ...
                    <table class="display" id="basic-1">
                        ...
                        <?php foreach( $data['requests'] as $request){
                          ...
                          <tr>
                            ...
                            <td><?php
                            if($request->document && ($status == "3" || $status == "6" || $status == "9")){
                              echo "<a href='/profiles/$request->document' target='_BLANK'>View</a>";
                            ...
                            if($request->response_remark4){
                              echo $request->response_remark4;
                            }
                            elseif($request->response_remark3){
                              echo $request->response_remark3;
                            }
                            elseif($request->response_remark2){
                              echo $request->response_remark2;
                            }
                            elseif($request->response_remark){
                              echo $request->response_remark;
                            }
