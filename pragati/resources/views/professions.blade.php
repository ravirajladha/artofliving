                      ...
                      <div class="row">
                        <div class="col">
                          <div class="mb-3">
                            ...
                            <input class="form-control" type="text" name="profession" placeholder="Enter Profession Name *" required>
                          </div>
                        </div>
                      </div>
                      <div class="row">
                    ...
                    <div class="table-responsive">
                      <table class="table table-bordernone">
                        ...
                        <?php foreach($data['professions'] as $profession){?>
                          <tr>
                            <td> <h6><?php echo $profession->id; ?></h6> </td>
                            <td> <h6><?php echo $profession->name; ?></h6> </td>
                            <td> </td>
                          </tr>
                       <?php } ?>
                        </tbody>
