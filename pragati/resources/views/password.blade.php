      ...
      <div class="row">
        <div class="col-12">
          <div class="login-card">
              ...
              <form method="post" class="theme-form login-form" action="/update_password" autocomplete="off">
                @csrf
              ...
              <h3 style="margin:15px 0px">PRAGATI</h3></center><hr>
                ...
                <div class="form-group">
                  <button class="btn btn-primary btn-block" type="submit">Change & Sign In</button>
                </div>
