            ...
            <div class="page-title">
              <div class="row">
                <div class="col-12 col-sm-10">
                  <h3>
                    {{ ucwords($data['event']->event_name) }} <span style="font-size:18px">({{$data['event']->id}})</span>
                  ...
                  <div class="card-body">
                    <div class="media static-widget">
                      <div class="media-body">
                        ...
                        <h4 class="mb-0 counter">{{$data['passes']}}</h4>
                      </div>
              ...
              <div class="col-sm-6 col-xl-3 col-lg-6">
                <div class="card o-hidden">
                  <div class="card-body">
                    <div class="media static-widget">
                      <div class="media-body">
                        <h6 class="font-roboto">Unused Passes</h6>
                        <h4 class="mb-0 counter">{{$data['unused']}}</h4>
                      </div>
              ...
              <div class="col-sm-6 col-xl-3 col-lg-6">
                <div class="card o-hidden">
                  <div class="card-body">
                    <div class="media static-widget">
                      <div class="media-body">
                        <h6 class="font-roboto">Entered</h6>
                        <h4 class="mb-0 counter">{{$data['entered']}}</h4>
                      </div>
              ...
              <div class="col-sm-6 col-xl-3 col-lg-6">
                <div class="card o-hidden">
                  <div class="card-body">
                    <div class="media static-widget">
                      <div class="media-body">
                        <h6 class="font-roboto">Exited</h6>
                        <h4 class="mb-0 counter">{{$data['exited']}}</h4>
                      </div>
                ...
                <div class="card">
                      ...
                      <script>
                        ...
                        data: {
                          datasets: [
                            {
                              data: [{{$data['passes']}}, {{$data['used']}}, {{$data['unused']}}],
                              backgroundColor: [
                                'rgb(255, 99, 132)',
                                'rgb(255, 159, 64)',
                                'rgb(255, 205, 86)',
...
var yValues = [{{$data['passes']}},{{$data['used']}},{{$data['unused']}}];
