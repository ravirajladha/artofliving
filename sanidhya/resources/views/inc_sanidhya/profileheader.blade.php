...
<body>
    ...
    <div class="page-wrapper compact-wrapper" id="pageWrapper">
                    ...
                    <ul class="nav-menus">
                        ...
                        <li class="onhover-dropdown">
                            <div class="notification-box">
                                ...
                                </svg><span class="badge rounded-pill badge-warning">0 </span>
                            </div>
                        ...
                        <li class="profile-nav onhover-dropdown pe-0 py-0 me-0">
                            ...
                            <ul class="profile-dropdown onhover-show-div" style="margin-top:-30px">
                                <li><a href="/profilelogout"><i data-feather="log-in"> </i><span>Log Out</span></a></li>
                            </ul>
                        </li>
                    </ul>
                </div>
        ...
        <div class="page-body-wrapper">
            ...
            @include("inc_sanidhya.profilenavbar")
            ...
            <style>
                ...
                .ongoing-project.recent-orders table tr th:first-child,
                .ongoing-project.recent-orders table tr td:first-child {
                    min-width: 15px;
                }
            </style>