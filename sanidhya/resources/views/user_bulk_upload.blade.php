      ...
      <div class="row">
        ...
        <div class="col-12 col-sm-6">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="/csvfile/user_upload.csv" download="user_upload.csv" data-bs-original-title="" title="">Download File</a>
              ...
              <div class="col-sm-12">
                <div class="card">
                  <div class="card-body">
                    ...
                    <form action="/bulk_create_user" method="POST" enctype="multipart/form-data">
                      @csrf
                      <div class="row">
                        <div class="col">
                          <div class="mb-3">
