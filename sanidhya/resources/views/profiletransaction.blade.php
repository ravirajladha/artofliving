...
use App\Models\Transaction;
 ...
 $profile = Profile::where('phone', $number)->first();

 if ($profile) { 
     $donations = Transaction::where('phone_number', $profile->phone)->get();
    
 } else {
     dd('Profile not found for phone number: ' . $number);
 }
                                        ...
                                        <div class="table-responsive">
                                            <table class="display" id="basic-1">
                                                ...
                                                <tbody>
                                                    ...
                                                    @foreach(  $donations as $transaction)
