        ...
        <div class="row">
          ...
          <div class="col-sm-12 framworks">
            ...
            <form method="post" class="login-new" action="user_login" autocomplete="off">
              @csrf
              <center>
                <h3 style="margin:15px 0px;color:#333">Sanidhya</h3>
              </center>
              <hr>
              ...
              <div class="form-group">
                <div class="captcha-box">
                  ...
                  <br>
                  <center>
                    <h4 style="color:#333">Click to Profile<a style="color:#333;text-decoration:underline" class="ms-2" href="/profilelogin">Signup.</a></h4>
                  </center>
                </div>
              </div>
          </div>
