...
<div class="page-body">
      ...
      <div class="row">
        ...
        <div class="col-12 col-sm-6">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="/csvfile/aprex_upload.csv" download="aprex_upload.csv" data-bs-original-title="" title="">Download File</a>
            </li>
            <li class="breadcrumb-item active"><a href="add_aprex_bulk_upload">
                <i data-feather="add_aprex_bulk_upload"></i>Bulk upload</a>
            </li>
          </ol>
        </div>
      </div>
  ...
  <div class="container-fluid">
    <div class="edit-profile">
      <form action="create_apex" method="POST">
        @csrf
        <div class="row">
          <div class="col-xl-12">
            <div class="card">
              ...
              <div class="card-body">
                ...
                <div class="row">
                  ...
                  <div class="col-md-6">
                    <div class="mb-3">
                      ...
                      <!-- <input class="form-control" name="email" type="email" placeholder="Value *" onblur="checkEmail()"> -->
                ...
                <div class="mb-3">
                    <label>Phone</label>
                    <input class="form-control" name="phone" type="tel" placeholder="Value *" data-check-phone="/check-phone" pattern="\d*" maxlength="10">
                  ...
                  <div class="col-md-6">
                    <div class="mb-3">
                      <label>Apex</label>
                      <input class="form-control" name="apex" type="text" placeholder="Value *">
                    </div>
                  </div>
                </div>
              </div>
