            ...
            <div class="page-title">
              <div class="row">
                <div class="col-12 col-sm-10">
                  <h3>Welcome <?php echo ucwords(session('rexkod_apex_user_name')); ?>,&nbsp;
                    <?php $type = session('rexkod_apex_user_type');
                     if($type=='itadmin'){
                      echo "IT Admin";
                    }elseif($type=='owner'){
                      echo "Stock Owner";
                ...
                <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="/index"> <i data-feather="home"></i> Dashboard</a></li>
                    </ol>
                </div>
              </div>
            </div>
            ...
            <div class="row">
                  ...
                  <div class="card-body">
                    <div class="media static-widget">
                      <div class="media-body">
                        <h6 class="font-roboto">Assets</h6>
                        <h4 class="mb-0 counter"><?php echo $data['assets']; ?></h4>
                      </div>
                  ...
                  <div class="card-body">
                    <div class="media static-widget">
                      <div class="media-body">
                        ...
                        <h4 class="mb-0 counter"><?php echo $data['users']; ?></h4>
                      </div>
                  ...
                  <div class="card-body">
                    <div class="media static-widget">
                      <div class="media-body">
                        ...
                        <h4 class="mb-0 counter"><?php echo $data['used_assets']; ?></h4>
                      </div>
              ...
              <div class="col-sm-6 col-xl-3 col-lg-6">
                <div class="card o-hidden">
                  <div class="card-body">
                    <div class="media static-widget">
                      <div class="media-body">
                        <h6 class="font-roboto">Unassigned</h6>
                        <h4 class="mb-0 counter"><?php echo $data['unused_assets']; ?></h4>
                      </div>
                      <svg class="fill-danger" width="44" height="46" viewBox="0 0 44 46" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <div class="card-body">
                    <div class="row gy-4">
                      <div class="col-sm-2">
                        <div class="widget-card">
                          <div class="media align-self-center">
                            <div class="widget-icon bg-light-success" style="color:#f8a218"><i class="fa fa-exchange"></i></div>
                            <div class="media-body">
                              <h6>Transfers</h6>
                              <h5><span class="counter"><?php echo $data['assigns']; ?></span></h5>
                            </div>
                          </div>
                        </div>
                      </div>
                      <div class="col-sm-2">
                        <div class="widget-card">
                          <div class="media align-self-center">
                            <div class="widget-icon bg-light-danger" style="color:#f8a218"><i class="fa fa-ticket"></i></div>
                            <div class="media-body">
                              <h6>Tickets</h6>
                              <h5><span class="counter"><?php echo $data['tickets']; ?></span></h5>
                            </div>
                          </div>
                        </div>
                      </div>
                      <div class="col-sm-2">
                        <div class="widget-card">
                          <div class="media align-self-center">
                            <div class="widget-icon bg-light-warning">  <div class="widget-icon bg-light-success" style="color:#f8a218"><i class="fa fa-life-ring"></i></div></div>
                            <div class="media-body">
                              <h6>Incidents</h6>
                              <h5><span class="counter"><?php echo $data['incidents']; ?></span></h5>
                            </div>
                          </div>
                        </div>
                      </div>
                      <div class="col-sm-2">
                        <div class="widget-card">
                          <div class="media align-self-center">
                            <div class="widget-icon bg-light-success">  <div class="widget-icon bg-light-info" style="color:#f8a218"><i class="fa fa-location-arrow"></i></div></div>
                            <div class="media-body">
                              <h6>Locations</h6>
                              <h5><span class="counter"><?php echo $data['locations']; ?></span></h5>
                            </div>
                          </div>
                        </div>
                      </div>
                      <div class="col-sm-2">
                        <div class="widget-card">
                          <div class="media align-self-center">
                            ...
                            <div class="media-body">
                              <h6>Asset Audit</h6>
                              <h5><span class="counter"><?php echo $data['asset_audit']; ?></span></h5>
                            </div>
                          </div>
                        </div>
                      </div>
                      <div class="col-sm-2">
                        <div class="widget-card">
                          <div class="media align-self-center">
                            <div class="widget-icon bg-light-success">  <div class="widget-icon bg-light-info" style="color:#f8a218"><i class="fa fa-location-arrow"></i></div></div>
                            <div class="media-body">
                              <h6>Property Audit</h6>
                              <h5><span class="counter"><?php echo $data['property_audit']; ?></span></h5>
                            </div>
                          </div>
                        </div>
                      </div>
              ...
              <div class="col-xl-12 col-md-12 dash-xl-100 dash-lg-100 dash-39">
                <div class="card ongoing-request recent-orders">
                  ...
                  <div class="card-body pt-0"><h3>Notifications</h3><br>
                           ...
                           <td><?php echo $notification->type; ?></td>
                            ...
                            <td>
                                ...
                                //if($notification->type == "assign" && $notification->status == "0"){ ?>
                                    ...
                                    {{-- <input onKeyup="check_aid(<?php echo $notification->id; ?>,<?php echo $notification->asset_id; ?>,this.value)" type="text" class="form-control" placeholder="Enter Asset ID" style="margin-bottom:5px">
                                    <div class="row">
                                      <div class="col-md-6">
                                      <a style="display:none" id="<?php echo $notification->id ?>" href="/assign_response/<?php echo $notification->id; ?>/<?php echo $notification->asset_id; ?>/1"><button class="btn btn-sm btn-success" style="padding:3px;font-size:11px">Accept</button></a>
                                      </div>

                                    <div class="col-md-6">  <a href="/assign_response/<?php  echo $notification->id; ?>/<?php echo $notification->asset_id; ?>/3"><button class="btn btn-sm btn-warning" style="padding:3px;font-size:11px">Reject</button></a></div>
                                    </div> --}}
                                <?php //} ?>
                            </td>
