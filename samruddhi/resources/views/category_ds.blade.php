                    ...
                    <div class="table-responsive">
                      {{-- <table class="table table-bordernone">  --}}
                        ...
                        <?php foreach($data['category'] as $category){?>
                          <tr>
                            <td> <h6><?php echo $category->id; ?></h6> </td>
                            <td> <h6><?php echo $category->name; ?></h6> </td>
                            <!-- <td> <h6><a href="/edit_category/<?php echo $category->id; ?>">
                            ...
                            <td><h6>
                              <button title="Edit" class="btn btn-xs btn-info"
                                            data-bs-toggle="modal" onclick="category_update(<?php echo $category->id; ?>,'<?php echo $category->name; ?>')"
                            ...
                            <td>
                              ...
                              <a href="/change_status_cat/<?php echo $category->id; ?>/1">
                              ...
                              <?php } else { ?>
                              <a href="/change_status_cat/<?php echo $category->id; ?>/0">
                                  <span style="font-size:10px" >
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-bookmark needs-validation" id="bookmark-form" novalidate="" action="/update_category" method="POST">
                    @csrf


                    <div class="col-md-12 mt-0 m-b-20">
                    <label>Category Name</label>
                            <input class="form-control" type="text" name="name" id="category_name_val" placeholder="Enter Category Name">
                            <input class="form-control" name="id"  id="category_id_val" type="hidden" placeholder="Value *" readonly>
                    </div>
...
function category_update(id, name) {
    ...
    $('#category_id_val').val(id);
    $('#category_name_val').val(name);
