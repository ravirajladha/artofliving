@include('inc.header')
<?php $compliance = $data['compliance']; ?>
...
<div class="page-body">
              ...
              <div class="row">
                ...
                <div class="col-12 col-sm-6">
                  ...
                  <li class="breadcrumb-item"><a href="/index"> <i data-feather="home"></i> Home</a></li>
                        ...
                        <li class="breadcrumb-item"><a href="/compliances_ds">Compliances</a></li>
                        <li class="breadcrumb-item active"><a href="/edit_compliances">Edit Compliances</a></li>
                  </ol>
                </div>
              </div>
            </div>
          ...
          <form action="/update_compliance" method="POST" enctype="multipart/form-data">
            @csrf
          <div class="container-fluid">
            <div class="row">
              <div class="col-sm-12">
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                          <div class="mb-3">
                            ...
                            <input class="form-control" type="text" name="name" value="<?php echo $compliance->name;?>" placeholder="Enter Compliance Name">
                            <input class="form-control" name="id" value="<?php echo $compliance->id; ?>" type="hidden" placeholder="Value *" readonly>
                          </div>
                        </div>
                        </div>
