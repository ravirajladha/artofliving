...
<div class="page-body">
              ...
              <div class="row">
                ...
                <div class="col-12 col-sm-6">
                  ...
                  <li class="breadcrumb-item"><a href="/index"> <i data-feather="home"></i> Home</a></li>
                        <li class="breadcrumb-item active"><a href="#">Add Asset Audit</a></li>
                  </ol>
                </div>
              </div>
            </div>
          ...
          <form action="/add_asset_audit" method="POST" enctype="multipart/form-data">
            @csrf
          <div class="container-fluid">
            <div class="row">
              <div class="col-sm-12">
                <div class="card">
                  <div class="card-body">
                    ...
                    <div class="col-md-3">
                        ...
                        <select class="form-select" name="location_id" class="form-control" id="location_id" oninput="location_url(this.value)">
              ...
              <div class="col-xl-12 xl-100 box-col-7">
                ...
                //$pageMod = new Page;
                 ...
                 foreach($data['get_all_assets'] as $asset){ 
                  $assign = Assigns::where('asset_id',$asset->id)->get();
                  $subcategory = Subcategory::where('id',$asset->subcategory_id)->get();
                  // print_r($subcategory);
                  
                 // if($_SESSION['rexkod_apex_user_type'] == "hq" || $asset->owner_id == $_SESSION['rexkod_apex_user_id']){ 
                ?>


                   <tr>
                          <td>
                          <input  type="checkbox" name="asset_id[]"  value="<?php echo $asset->id; ?>">
                            </td>
                          <td>
                            <?php echo $asset->id; ?>
                            </td>
                            ...
                            <td> 
                              <h6><?php echo $asset->subcategory_id;  ?></h6>
                            </td>
...
<script>
	function location_url(location_id){
		window.location.href = '/add_asset_audit/' + location_id;
	}
</script>
