            ...
            <div class="page-title">
              <div class="row">
                ...
                <div class="col-12 col-sm-6">
                  ...
                  <li class="breadcrumb-item "> <a  href="/add_user">Add Asset</a></li>
                  <li class="breadcrumb-item active"> <a  href="#">Asset Bulk Upload</a></li>
              ...
              <div class="col-sm-12">
                <div class="card">
                  <div class="card-body">
                    ...
                    <form action="/upload_asset" method="POST" enctype="multipart/form-data">
                      @csrf
                      <div class="row">
                        <div class="col">
                          <div class="mb-3">
