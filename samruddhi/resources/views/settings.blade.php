...
<div class="page-body">
  ...
  <form action="/update_settings/<?php echo $user->id; ?>" method="POST" enctype="multipart/form-data">
    @csrf
          ...
          <div class="col-xl-3">
            <div class="card">
              ...
              <div class="card-body">
                    ...
                    <div class="media">
                      ...
                      <div class="media-body">
                        <?php if (!empty($user->photo)) { ?>
                          <center>   <img class="img-75 rounded-circle" alt="" src="/uploads/<?php echo $user->photo; ?>" style="height:90px; width:100px"> </center>
                        <?php } else { ?>
                          <center>   <img class="img-75 rounded-circle" alt="" src="/assets/images/user/7.jpg" style="height:100px; width:90px">    </center>
                        <?php   } ?>
                ...
                <?php
                $type = Session::get('rexkod_apex_user_type');
                ?>
