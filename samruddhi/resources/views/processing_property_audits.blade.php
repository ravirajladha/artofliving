...
<div class="page-body">
    ...
    <div class="page-title">
      <div class="row">
        <div class="col-12 col-sm-6">
          <h3>Processing Property Audits</h3>
        </div>
        <div class="col-12 col-sm-6">
          <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="/pages/index"> <i data-feather="home"></i></a></li>
            <li class="breadcrumb-item">Processing Property Audits</li>
  ...
  <div class="container-fluid general-widget">
    ...
    <div class="row">
      ...
      //   $audits = $this->pageModel->get_from_property_audits($audit_detail->id,$property_id);
      // if(!empty($audits)){ 
        ...
        <div class="col-sm-12">
          <div class="card">
            <div class="card-body">
              ...
              <?php //$get_asset = $pageMod->get_asset($property_id); ?>
              <?php //echo ucwords($get_asset->name); ?></h5>
              <hr>
              <div class="form theme-form projectcreate">
                <form action="/pages/update_single_property_audit/<?php //echo $data['audit_id']; ?>/<?php //echo $property_id; ?>" method="POST" enctype="multipart/form-data">
                  <div class="row">
