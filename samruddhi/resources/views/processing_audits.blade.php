...
<div class="page-body">
  ...
  <div class="container-fluid general-widget">
    ...
    <div class="row">
      ...
      //   $audits = $this->pageModel->get_from_audits($audit_detail->id,$asset_id);
      // if(!empty($audits)){ 
          ...
          <div class="card">
            <div class="card-body">
              ...
              <div class="form theme-form projectcreate">
                <form action="/pages/update_single_audit/<?php //echo $data['audit_id']; ?>/<?php //echo $asset_id; ?>" method="POST" enctype="multipart/form-data">
                  <div class="row">
