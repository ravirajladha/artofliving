...
<div class="page-body">
          ...
          <form action="/pages/create_audit" method="POST" enctype="multipart/form-data">
          <div class="container-fluid">
            <div class="row">
              <div class="col-sm-12">
                <div class="card">
              ...
              <div class="col-xl-12 xl-100 box-col-7">
                ...
                //  $assign = $pageMod->check_assign($asset->id);
                //  $subcategory = $pageMod->get_subcategory($asset->subcategory_id);
            ...
            <div class="row">
                        <div class="col">
                          <div class="text-end"><button class="btn btn-secondary me-3" type="submit">Create Audit</button></div>
                        </div>
                      </div>
...
<script>
	function location_url(location_id){
		window.location.href = '/pages/add_audit/' + location_id;
	}
</script>
