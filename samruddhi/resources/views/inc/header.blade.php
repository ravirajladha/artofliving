...
<html lang="en">
  <head>
    <?php
     ...
     $notifications= Notifications::where('user_id',Session::get('rexkod_apex_user_id'))
                     ->where('status', '0')
                     ->where('action', '0')
                     ->orderBy('id','desc')
                     ->get();
...
.logo-wrapper, .logo-icon-wrapper {
        ...
        <div class="header-wrapper row m-0">
          ...
          <form action="/results" method="POST">
            ...
            <div class="input-group"><span class="input-group-text" id="basic-addon1">
              ...
              <input class="form-control" type="text" name="search" placeholder="Search Assets" aria-label="search" aria-describedby="basic-addon1">
            ...
            ?>
              ...
              <li class="onhover-dropdown">
                <div class="notification-box">
                  ...
                  </svg><span class="badge rounded-pill badge-warning">
  ...
  <li><a href="/user/{{Session::get('rexkod_apex_user_id')}}"><i data-feather="user"></i><span>Account </span></a></li>
