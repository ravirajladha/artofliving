...
<div class="page-body">
              ...
              ?>
                <tr>
                  <td class="img-content-box">
                    <h6><?php
                        $get_asset = Assets::where('id',$audits->asset_id)->first();
                  ...
                  <td class="img-content-box">
                    ...
                    <h6><?php if($audits->not_found==1){
                      echo 'Not Found';
                    } elseif($audits->unassigned_asset==1){
                      echo 'Unassigned';
                    }else{
                      echo 'Found';
                    }
  ...
  <div class="text-end">
    <a href="/asset_audits" class="btn btn-secondary me-3">Back</a>
    </div>
