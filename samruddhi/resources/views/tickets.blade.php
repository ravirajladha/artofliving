                                    ...
                                    <div class="card-body support-ticket-font">
                                        <div class="row">
                                            <div class="col-5"><span>Pending</span>
                                                <h3 class="total-num counter"><?php echo $pending;
                                                ?></h3>
                                            </div>
                                            <div class="col-7">
                                                <div class="text-end">
                                    ...
                                    <div class="card-body support-ticket-font">
                                        <div class="row">
                                            <div class="col-5"><span>Completed</span>
                                                <h3 class="total-num counter"><?php echo $completed;
                                                ?></h3>
                                            </div>
                                            <div class="col-7">
                                                <div class="text-end">
                                    ...
                                    <div class="card-body support-ticket-font">
                                        <div class="row">
                                            <div class="col-5"><span>Total</span>
                                                <h3 class="total-num counter"><?php echo $total;
                                                ?></h3>
                                            </div>
                                            <div class="col-7">
                                                <div class="text-end">
                            ...
                            {{-- <table class="display table table-bordernone" id="basic-1"> --}}
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <?php if(in_array(24, $user_priviliges)) {?>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="img-content-box">
                                            <h6><?php if (isset($user->name)) {
                                                echo $user->name;
                                            }
                                            ?></h6><span><?php if (isset($building->name)) {
                                                echo $building->name;
                                            }
                                            ?></span>
                                        </td>
                                        ...
                                        <td>
                                            <a href="/ticket/<?php echo $ticket->id; ?>">
                                                <button style="font-size:12px;padding:2px 5px"
