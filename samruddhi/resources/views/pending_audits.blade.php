...
<div class="page-body">
    ...
    <div class="page-title">
      <div class="row">
        <div class="col-12 col-sm-6">
          <h3>Pending Asset Audits</h3>
        </div>
        <div class="col-12 col-sm-6">
          <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="<?php //echo URLROOT ?>/pages/index"> <i data-feather="home"></i></a></li>
            <li class="breadcrumb-item">Pending Asset Audits</li>
  ...
  <div class="container-fluid general-widget">
    ...
    <div class="row">
      ...
      // $get_from_audits =   $pageMod->get_from_audits($audit_detail->id,$asset_id);
        ...
        <div class="col-sm-12">
          <div class="card">
            <div class="card-body">
              ...
              <?php //$get_asset = $pageMod->get_asset($asset_id); ?>
              <?php // echo ucwords($get_asset->name); ?></h5>
              <hr>
              <div class="form theme-form projectcreate">
                <form action="/pages/create_single_audit/<?php //echo $data['audit_id']; ?>/<?php //echo $asset_id; ?>" method="POST" enctype="multipart/form-data">
                  <div class="row">
