    ...
    <div class="page-title">
      <div class="row">
        <div class="col-12 col-sm-6">
          <h3>Pending Property Audits</h3>
        </div>
        <div class="col-12 col-sm-6">
          <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="/pages/index"> <i data-feather="home"></i></a></li>
            <li class="breadcrumb-item">Pending Property Audits</li>
  ...
  <div class="container-fluid general-widget">
    ...
    <div class="row">
      ...
      $all_property_id = explode(',', $property_id);
       ...
       $get_from_audits =  App\Models\Property_audits::where('audit_id',$audit_detail->id)
        ...
        <div class="col-sm-12">
          <div class="card">
            <div class="card-body">
              ...
              <?php $get_property =  App\Models\Property::where('id',$property_id) ->first(); ?>
              <?php echo ucwords($get_property->name); ?></h5>
              <hr>
              <div class="form theme-form projectcreate">
                <form action="/pages/create_single_property_audit/<?php echo $data['audit_id']; ?>/<?php echo $property_id; ?>" method="POST" enctype="multipart/form-data">
                  <div class="row">
             
                      <div class="col-md-4">
												<label>Asset Current Condition</label>
                      ...
                      <div class="col-md-4">
                        <label>Document Upload<span>*</span></label>
                        <input class="form-control" type="file" name="file" required>
                      </div>
                      <div class="col-md-4">
                        <label>Notes</label>
                       <textarea class="form-control" name="notes" type="text" placeholder="Enter Notes for reference *" required></textarea>
                      </div>
                      </div>
               <br>
                  <div class="row">
                             ...
                             <ul>
                              ...
                              // $compliances = explode(',', $subcat->compliances);
                               //foreach ($compliances as $compliance) {
                                 //$comp = App\Models\Compliances::where('id',$compliance)->first();
                              ?>
