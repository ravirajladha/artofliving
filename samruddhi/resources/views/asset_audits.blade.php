    ...
    <div class="page-title">
      <div class="row">
        <div class="col-12 col-sm-6">
          <h3>Asset Audit Master</h3>
        </div>
        <div class="col-12 col-sm-6">
        <ol class="breadcrumb">
                  <li class="breadcrumb-item"><a href="/index"> <i data-feather="home"></i> Home</a></li>
                        <li class="breadcrumb-item active"><a href="#">Asset Audit Master</a></li>
                  </ol><br>
                  <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="/assets/audit_upload.csv" download="audit_upload.csv">Download File</a></li>

                    <li class="breadcrumb-item"><a href="/audit_upload"> Upload Audits</a></li>
                </ol>
            ...
            <tbody>
              <?php
               ...
               foreach ($data['audits'] as $audit) {
                 ...
                 $ind_asset_id = explode(',', $asset_id);
                 foreach ($ind_asset_id as $single_asset_id) {
                 $get_from_audits =  Asset_audits::where('audit_id',$audit->id)
                ->where('asset_id',$single_asset_id)
                ->first();
              ...
              ?>
                ...
                <tr>
                  ...
                  <td>
                    <h6><?php echo date("d-m-Y", strtotime($audit->end_date));  ?>
                    </h6>
                  ...
                  <?php if (($audit->status == "0") && in_array(15, $user_priviliges)) { ?>
                      <h6 class="font-roboto"><a href="/change_asset_audit_status/<?php echo $audit->id; ?>"><button class="btn btn-xs btn-success" style="padding:2px;font-size:11px">Start</button></a></h6>

                    <?php } elseif (($audit->status == "1") && in_array(16, $user_priviliges)) { ?>
                      <h6 class="font-roboto">

                        <a href="/update_asset_audits/<?php echo $audit->id; ?>"><button class="btn btn-xs btn-primary" style="padding:2px;font-size:11px">Edit</button></a>
                      </h6>
                    <?php } elseif (($audit->status == "2") && in_array(17, $user_priviliges)) { ?>
                      <h6 class="font-roboto">
                        <a href="/view_asset_audit/<?php echo $audit->id; ?>"><button class="btn btn-xs btn-success" style="padding:2px;font-size:11px">View</button></a>
                      <?php } ?>
