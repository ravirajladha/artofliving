              ...
              <div class="row">
                ...
                <div class="col-12 col-sm-6">
                  <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item">Compliances</li>
              ...
              <div class="col-sm-12">
                <div class="card">
                  <div class="card-body">
                    ...
                    <form action="/compliances" method="POST">
                      @csrf
                      <div class="row">
                        <div class="col">
                          <div class="mb-3">
                  ...
                  <div class="card-header card-no-border">
                    <div class="media media-dashboard">
                      <div class="media-body"> 
                        <h5 class="mb-0">All Compliance</h5>
                      </div>
                  ...
                  <div class="card-body pt-0">
                    <div class="table-responsive">
                      <table class="table table-bordernone">
                        ...
                        <tbody> 
                        <?php foreach($data['compliances'] as $compliances){?>
                          <tr>
                            <td> <h6><?php echo $compliances->id; ?></h6> </td>
                            <td> <h6><?php echo $compliances->name; ?></h6> </td>
                            <td> </td>
                          </tr>
                       <?php } ?>
                        </tbody>
